...
def detailed_test_evaluation():
    ...
    print("归一化混淆矩阵已保存为 confusion_matrix_normalized.png")
...
if __name__ == "__main__":
    ...
    print("- detailed_test_results.npy (详细测试结果)")
    print("- train_losses.npy, train_accuracies.npy, val_losses.npy, val_accuracies.npy (训练历史)")